...
\begin{frame}{VRNN - Toy training}
    \begin{center}
    \includegraphics[width=0.8\textwidth]{/home/benjamin/Folders_Python/MVA/MVA_Stage/images/vrnn_loss.png}
    \end{center}
    % \caption{VRNN Loss}
\end{frame}
...
\begin{frame}{VRNN - Toy training}
    \begin{center}
    \includegraphics[width=0.5\textwidth]{/home/benjamin/Folders_Python/MVA/MVA_Stage/images/vrnn_preds.png}
