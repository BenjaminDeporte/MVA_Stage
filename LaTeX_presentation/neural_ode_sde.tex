...
\begin{frame}{Latent ODE - model}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{/home/benjamin/Folders_Python/MVA_Stage/images/Neural_ODE_01.png}
...
\begin{frame}{Latent SDE - generative model}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{/home/benjamin/Folders_Python/MVA_Stage/images/Latent_SDE_01.png}
