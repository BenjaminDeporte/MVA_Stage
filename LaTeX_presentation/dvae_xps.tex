...
\begin{frame}{DKF - Toy training - Loss}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=1.0\textwidth]{/home/benjamin/Folders_Python/MVA_Stage/images/dkf_loss.png}
    \end{center}
    % \caption{DKF Loss}
\end{frame}
...
\begin{frame}{DKF - Toy training - Generations}
    \begin{center}
    \includegraphics[width=0.8\textwidth]{/home/benjamin/Folders_Python/MVA_Stage/images/dkf_preds_gens.png}
...
\begin{frame}{VRNN - Toy training - Loss}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=1.0\textwidth]{/home/benjamin/Folders_Python/MVA_Stage/images/vrnn_loss.png}
    \end{center}
    % \caption{VRNN Loss}
\end{frame}
...
\begin{frame}{VRNN - Toy training - Generation}
    \begin{center}
    \includegraphics[width=0.6\textwidth]{/home/benjamin/Folders_Python/MVA_Stage/images/vrnn_preds.png}
...
\begin{frame}{Sprites dataset}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.2\textwidth]{/home/benjamin/Folders_Python/MVA_Stage/images/one_sprite.png}
        \caption{One sprite}
...
\begin{frame}{Sprites series}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{/home/benjamin/Folders_Python/MVA_Stage/images/samples_sprites_series.png}
...
\begin{frame}{VRNN Reconstruction on Sprites}
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{/home/benjamin/Folders_Python/MVA_Stage/images/vrnn_sprites_reconstruction.png}
...
\begin{frame}{VRNN Generation on Sprites}
    \begin{figure}[H]
        \centering
        \includegraphics[width=1.0\textwidth]{/home/benjamin/Folders_Python/MVA_Stage/images/vrnn_sprites_generation.png}
...
\begin{frame}{GPVAE - Toy training - Loss}
    ...
    \begin{center}
    \includegraphics[width=1.0\textwidth]{/home/benjamin/Folders_Python/MVA_Stage/images/gpvae_loss.png}
    \end{center}
    % \caption{GPVAE Loss}
\end{frame}
...
\begin{frame}{GPVAE - Toy training - Generations}
    \begin{center}
    \includegraphics[height=0.8\textheight]{/home/benjamin/Folders_Python/MVA_Stage/images/gpvae_preds.png}
...
\begin{frame}{GPVAE - Sprites Reconstruction - 1}
    \begin{figure}[H]
    \centering
    \includegraphics[height=0.75\textheight]{/home/benjamin/Folders_Python/MVA_Stage/images/gpvae_reco_01.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.75\textheight]{/home/benjamin/Folders_Python/MVA_Stage/images/gpvae_reco_02.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.75\textheight]{/home/benjamin/Folders_Python/MVA_Stage/images/gpvae_reco_03.png}
...
\begin{frame}{GPVAE - Generation}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[height=0.8\textheight]{/home/benjamin/Folders_Python/MVA_Stage/images/gpvae_gen_01.png}
