...
\begin{frame}{Dynamical Variational Auto Encoders : generalities}
    \begin{itemize}
        ...
        \item <2-> Untractable true posterior $\implies$ training by maximizing a \gls{vlb}
    \end{itemize}
\end{frame}
...
\begin{frame}{Second model : Variational RNN}
    \begin{itemize}
        ...
        \item The \gls{gpm} of the \gls{vrnn} assumes full connections between latent variables, and between observed variables.
    \end{itemize}
