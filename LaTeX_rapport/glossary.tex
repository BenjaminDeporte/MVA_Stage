...
\newacronym{latent ode}{Latent ODE}{Latent Ordinary Differential Equation model}
\newacronym{latent sde}{Latent SDE}{Latent Stochastic Differential Equation model}
\newacronym{state-space-model}{SSM}{State Space Model}
