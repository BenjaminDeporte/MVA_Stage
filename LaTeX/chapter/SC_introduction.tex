...
This chapter is a reminder of some key notions of stochastic calculus. More details are presented at the end of the report.
...
with a subdivison $\pi = \{s=t_0 < t_1 < ...< t_k <... < t_n=t\}$ defined as the limit when $\vert \pi \vert \rightarrow 0$ 
